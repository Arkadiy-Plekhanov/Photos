...
```
Optimize primary CTA with enhanced styling
```
      ...
      <div className="relative z-10 text-center text-white dark:text-gray-100 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        >
          <Link href="/#contact">
            <Button 
              size="lg" 
              className="bg-luxury-gold text-ocean-blue hover:bg-sunset-orange font-semibold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl"
            >
          ...
          <Link href="/portfolio">
            <Button 
              size="lg" 
              variant="outline" 
              className="border-white/30 text-white hover:bg-white/10 px-8 py-4 text-lg backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
            >
              <i className="fas fa-images mr-2"></i>
              View Portfolio
            </Button>
