...
// Create a simple index.html that redirects to development server
...
<body>
    <div class="loading">
        ...
        <p>Preparing your photography experience...</p>
...
console.log('Created production index.html with redirect');
